...
@Component({
  selector: 'app-new-device-color',
  templateUrl: './new-device-color.component.html',
  styleUrls: ['./new-device-color.component.scss']
})
export class NewDeviceColorComponent implements OnInit {
