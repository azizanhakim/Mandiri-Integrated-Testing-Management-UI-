...
@Injectable()
export class DeviceColorService {

  constructor(private _http: HttpClient) {
  }

  public datatables(value: DeviceColor, datatablesParameters: any) {
